...
test('App renders', async () => {
  mockFetchShow.mockResolvedValueOnce(appFixture);
  const {queryAllByTestId, findByText, findByLabelText} = render(<App/>);

  const dropdown = findByText('Select a season')
  const season1 = findByLabelText('Season 1')
...
// });
//   await waitFor(()=>{
//   fireEvent.mouseDown(season1, {button: 0});
//   fireEvent.mouseUp();
// });
